...
if (!text) throw `*[❗] هذا الامر خاص بي التحميل من منصة تويتر/أكس , متال: ${usedPrefix + command}* https://twitter.com/ghiblipicture/status/1762238885197709402?t=er-yegR4ELCFuu-T-ukvOA&s=19`;
if (enviando) return;
    enviando = true;
try {
...
handler.command = /^((x|xdl|dlx|twdl|tw|أكس|تويتر)(dl)?)$/i;
